...
public class FindCourses extends AppCompatActivity implements adapterFacultySearch.OnNoteListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView = findViewById(R.id.searchViewCourses);
        ...
        if (databaseReference!=null){
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(FindCourses.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
                }
            });
        }
    ...
    private void showUpdateDialog (final String id, String code, String name, String phone, String department) {
        ...
        final View diallogView = inflater.inflate(R.layout.update_dialogue_courses, null);
        ...
        dialogBuilder.setTitle("Updating Courses " + name);
    ...
    private Boolean updateArtist ( String id, String code, String name, String phone, String department) {
        ...
        Toast.makeText(this, "Courses Updated Successfully", Toast.LENGTH_LONG).show();
        return true;
    }
